// This is a copy of the watermill implementation
// because we needed to have a mechanism to stop after max retries.
...
var ErrMaxRetries error = errors.New("this message has been processed too many times, will be terminated")
...
type Retry struct {
	...
	// AckAfterMaxRetries sets the message as aknowledged after the max-retry count.
	AckAfterMaxRetries bool
